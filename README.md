...
|💡  [Web app creation for the analysis for the tweets toxicity ](https://github.com/Nadia365/Deployment-of-ML-model-to-Azure) |Tweets toxicity score after scraping from web using Twitter API| This repository contains the functions of scraping, and analyze social media posts (specifically Twitter) related to mental health topics such as #harcelement, using Natural Language Processing (NLP). The goal is to detect the toxiciy of the posts.(https://github.com/Nadia365/Deployment-of-ML-model-to-Azure) | pyhton/nlp toolkit/flask/docker/tweepy 
